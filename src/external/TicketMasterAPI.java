...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "s3AAxem8Gg8kA5oW1KiHEsMgR1HHIr6Z";
		...
		try {
				...
				if (!obj.isNull("_embedded")) {
						...
						for (int i = 0; i < embedded.getJSONArray("events").length(); ++i) {
					       ...
					       TicketMasterObject tobj = objectMapper.readValue(event.toString(), TicketMasterObject.class);
					       
					       // build Item object from the TicketMasterObject instance 
					    }
